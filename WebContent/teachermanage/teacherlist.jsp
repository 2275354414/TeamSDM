	...
	<script type="text/javascript">
		...
		function deleteUser(){
		    ...
		    $.messager.confirm("系统提示","您确定要删掉这<font color='red'>"+selectedRows.length+"</font>条数据么?",function(r){
		    	if(r){
		    		$.post("${pageContext.request.contextPath}/deleteTeacher.do",{delIds:ids},function(result){
		    			if(result.success){
		...
		function newUser(){
			...
			url="${pageContext.request.contextPath}/addteacher.do";
		}
		...
		function editUser(){
	    	...
	    	url="${pageContext.request.contextPath}/editTeacher.do?editId="
				+ row.teacher_id;
		}
...
<body style="margin:5px">
    <table id="dg" title="楼宇管理员基本信息" class="easyui-datagrid" style="width:900px;height:400px"
            url="${pageContext.request.contextPath}/getTeacherList.do" 
    ...
    <div id="toolbar">
      ...
      <div>
  		<form id="condition" name="condition" action="${pageContext.request.contextPath}/exportTeacher.do" method="post"> 
