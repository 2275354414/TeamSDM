...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/amq_jquery_adapter.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/amq.js"></script>
	...
	<script type="text/javascript" charset = "utf-8" >
		...
		function checkOk(){
	    	...
	    	/* $.post("${pageContext.request.contextPath}/checkIfOk.do?student_id="+studentId,null,function(result){
	    		if(result == "是"){
		    	...
		    	$.post("${pageContext.request.contextPath}/updataLack.do?student_id="+studentId,null,function(result){
					if(result.errorMsg){
						$.messager.alert("系统提示",result.errorMsg,"warning");
						return;
					}else{
...
<body style="margin:5px">
    ...
    <table id="dg" title="缺寝记录" class="easyui-datagrid" style="width:900px;"
            url="${pageContext.request.contextPath}/student/lackList.do" 
    ...
    <div id="toolbar">
      ...
      <div>
  		<form id="condition" name="condition" action="${pageContext.request.contextPath}/student/exportLackStudent.do" method="post"> 
      		&nbsp;&nbsp;
      		查询：
