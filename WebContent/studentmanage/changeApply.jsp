  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			// 查询出全部的Teacher列表
			$.post("${pageContext.request.contextPath}/queryAllTeacher.do?index="+Math.random(),null,callbackByBuilding);
		...
		function sendMsg(){
			...
			// 提交数据			
			$("#fm").form("submit",{
				url:"${pageContext.request.contextPath}/addNotice.do",
				onSubmit:function(){
	...
	<div id="mainWindow"  class="easyui-layout" fit="true" >  
	        		...
	        		<tr>
	        			...
	        			<td class="td">
	        				<select id="msg_type" name="notice.msg_type" class="easyui-combobox" style="width: 400">
	        					<option value="宿舍调换">宿舍调换申请</option>
	    ...
	    <div region="center" id="buttomWindow" title="申请记录" style="padding:5px;background:#eee;">
		    <table id="queryMsg" class="easyui-datagrid" style="width:900px;"
		            url="${pageContext.request.contextPath}/getNoticeList.do?send_userName=${sessionScope.userName }&send_person=${sessionScope.realName}" 
