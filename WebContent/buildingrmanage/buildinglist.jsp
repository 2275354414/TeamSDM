	...
	<script type="text/javascript">
		...
		function deleteUser(){
		    ...
		    $.messager.confirm("系统提示","您确定要删掉这<font color='red'>"+selectedRows.length+"</font>条数据么?",function(r){
		    	if(r){
		    		$.post("${pageContext.request.contextPath}/deleteBuilding.do",{delIds:ids},function(result){
		    			if(result.success){
		...
		function newUser(){
			...
			$("#fm").form("clear");
			url="${pageContext.request.contextPath}/saveBuilding.do";
		}
		...
		function editUser(){
	    	...
	    	url="${pageContext.request.contextPath}/saveBuilding.do?building_id="+row.building_id;
		}
		...
		//对应的楼宇的管理员
		 function buildingManager(){
		     ...
		     var row=selectedRows[0];
		     $('#dg1').datagrid({   
		         url: '${pageContext.request.contextPath}/getAllManager.do?building_id='+row.building_id+"&index="+1,
		         onLoadSuccess:function(data){
					$.get("${pageContext.request.contextPath}/getBuildingManager.do?building_id="+row.building_id,callback,"json");
				...
				$('#btnCancel').click(function(){
				 ...
				 $("#btnEp").click(function(){
					 var selectedRows=$("#dg1").datagrid("getSelections");
					    ...
					    var ids = strIds.join(",");
					    $.ajax({
					    	url: '${pageContext.request.contextPath}/setBuildingManager.do',
					    	type: 'POST',
					    	dataType: 'json',
					    	data: {teacherId_box: ids},
					    	success:function(result) {
					    		console.log(result);
					    		if (result.success) {
...
<body style="margin:5px">
    ...
    <table id="dg" title="楼宇基本信息" class="easyui-datagrid"
            url="${pageContext.request.contextPath}/buildinglist.do" 
    ...
    <div id="toolbar">
      ...
      <div>
      	&nbsp;&nbsp;<input type="text" id="b_name" name="b_name" placeholder="请输入要查询的楼宇名">
    ...
    <div id="dlg" class="easyui-dialog" style="width:420px;height:280px;padding:10px 20px"
        ...
        <form id="fm" method="post">
        	<table cellspacing="10px;">
        		<tr>
        			<td>楼宇名：</td>
        			<td><input name="building_name" id="building_name" class="easyui-validatebox" required="true" style="width: 200px;"></td>
        		</tr>
        		<tr>
        			<td>备&nbsp;注：</td>
        			<td><input name="building_remark" id="building_remark" class="easyui-validatebox" required="true" style="width: 200px;"></td>
        		</tr>
        	</table>
        </form>
    </div>
    ...
    <div id="w" class="easyui-window"  title="楼宇管理员" collapsible="false" minimizable="false"
        ...
        <div class="easyui-layout" fit="true">
            ...
            <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
                <a id="btnEp" type="submit" class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)">确定</a> 
