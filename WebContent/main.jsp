...
<html>
  <head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="js/jquery-easyui-1.3.2/themes/black/easyui.css"> -->
	<!-- <link rel="stylesheet" type="text/css" href="js/jquery-easyui-1.3.2/themes/gray/easyui.css"> -->
	<!-- <link rel="stylesheet" type="text/css" href="js/jquery-easyui-1.3.2/themes/metro/easyui.css"> -->
	...
	<script type="text/JavaScript"> 
	    ...
	    function showAbout(){
	    	$.messager.show({
				title:"系统设计 V1.0",
				msg:"设计: 第八组<br/>邮箱: 123456789@qq.com",
				timeout:5000
			});
	    }
		...
		$("#studenttreeVIPStudent").tree({
		  ...
		  function openTab(text,url){
			  if($("#tabs").tabs("exists",text)){
				  ...
				  var content="<iframe src="+url+" frameborder='0' scrolling='auto' style='width:100%;height:100%;font-family:'Microsoft YaHei';'></frame>";
				  $("#tabs").tabs("add",{
					  title:text,
					  content:content,
					  closable:true
	  ...
	  ///////////////////////////////////
	   //设置登录窗口
        ...
        function serverLogin() {
            ...
            $.post("${pageContext.request.contextPath}/updatePass.do?userPass="+ $newpass.val()+"&flag="+loginFlag+"&loginId="+loginId+"&inputOldPass="+inputOldPass, function(msg) {
            	if(msg == "false"){
            		$.messager.show({
	        			title:"系统提示",
	...
	<c:if test="${sessionScope.loginFlag == 'teacher'}">
		...
		<script type="text/javascript">
			//this.doit();
			 $(function(){
				$.post("${pageContext.request.contextPath}/qryNotOkNoticeListByTeacher.do?index="+Math.random()+"&rec_role=${sessionScope.loginFlag}"+"&rec_userName=${sessionScope.userName}",null,callback);
	...
	<c:if test="${sessionScope.loginFlag == 'student'}">
		...
		<script type="text/javascript">
			$(function(){
				...
				$.post("${pageContext.request.contextPath}/qryIfOfFlag.do?index="+Math.random()+"&rec_userName="+realName,null,function(data){
					if(data == 'true'){
						if (document.body == null) {		
							window.setTimeout(doit,500);
							return;
 ...
 <body class="easyui-layout">  
    ...
    <div region="north" border="true" split="false" 
        style="overflow: hidden; height: 50px; background-color:#E0EDFF;font-family:'Microsoft YaHei';">  
        
        <div id="topbar" class="title">
		     <span class="footer" style="width:200px;padding-left:100px">  
		           	<font style="color:#95B8E7; font-size:27px;font-weight:bold;font-family:'Microsoft YaHei';">
		           		<img border="0" style="width:40px;height:40px;vertical-align:-15px;" src="image/dormLogo.png"/>
		           		校园宿舍管理系统
		           	</font>
		     </span> 
		     <span style="padding-left:500px;font-family:'Microsoft YaHei';">
		     	<b>欢迎您：</b>
	        ...
	        <span id="topbar-logon" style="width:180px;float:right;padding-top:8px;font-family:'Microsoft YaHei';">
				...
				<div id="topbar-menu" style="width:150px;font-family:'Microsoft YaHei';">
    ...
    <div region="south" border="true" split="false"  
        style="overflow: hidden; height: 40px;font-family:'Microsoft YaHei';">  
        <div class="footer" style="font-family:'Microsoft YaHei';">  
			© 版权所有：<a class="myFont" href="http://www.zhku.edu.cn/" target="_blank">仲恺农业工程学院</a>&nbsp; &nbsp; QQ:123456789
        </div>  
    </div>  
  
  
  	<!-- left 最左边的 -->
    <div region="west" split="false" title="<center>导航菜单</center>" style="width: 200px;font-family:'Microsoft YaHei';">  
    	<!-- 系统管理员div -->
		<div id="showSystem" class="easyui-accordion"  fit="true">   
		    <div  data-options="iconCls:'icon-student'" title='学生管理' class="menuDiv"  style="overflow:auto;font-family:'Microsoft YaHei';"> 
  	...
  	<!--  正文部分 -->
    <div id="mainPanle" region="center" style="overflow: hidden;font-family:'Microsoft YaHei';">  
        <div id="tabs" class="easyui-tabs"  fit="true" >  
            <div title="欢迎使用" style="padding: 5px;font-family:'Microsoft YaHei';
            background-image: url(image/pic1.jpg); background-size: 100% 100%; " > 
            	<!--  style="background-image: url(image/welcome.gif)" -->
            	<div style="border:2px #95B8E7 solid;height:525px;font-family:'Microsoft YaHei';">
            		<center style="font-size:30px;font-family:'Microsoft YaHei';">欢迎使用校园宿舍管理系统<br></center>
	            	<table border="0" cellspacing="0" cellpadding="0" width="1104">
	            		<tr>
			                ...
			                <td><img src="image/pic1.jpg" width="1144" height="500"></td> -->
    ...
    <div id="w" class="easyui-window"  title="修改密码" collapsible="false" minimizable="false"
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 5px; height: 450px; background: #fff;
            font-family:'Microsoft YaHei'; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>原密码：</td>
            ...
            <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;font-family:'Microsoft YaHei';">
